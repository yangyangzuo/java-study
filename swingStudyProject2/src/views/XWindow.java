...
public class XWindow extends javax.swing.JFrame implements DropTargetListener {
	...
	*/
	...
	public XWindow() {
		...
		/*
		 * int[] pxs = { 2, 703, 703, 920, 920, 2 }; int[] pys = { 30, 30, 0, 0,
		 * 607, 607 }; Polygon shape = new Polygon(pxs, pys, 6);
	...
	private void initComponents() {
		...
		playpancontainer.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(27, 27, 27), 2));

		javax.swing.GroupLayout playpancontainerLayout = new javax.swing.GroupLayout(playpancontainer);
		playpancontainer.setLayout(playpancontainerLayout);
		playpancontainerLayout.setHorizontalGroup(playpancontainerLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 789, Short.MAX_VALUE));
		...
		exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/x.png"))); // NOI18N
		...
		minimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/min.png"))); // NOI18N
		...
		toppaneLayout
				.setHorizontalGroup(toppaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(toppaneLayout.createSequentialGroup()
								.addContainerGap().addGroup(toppaneLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
												javax.swing.GroupLayout.Alignment.TRAILING,
												toppaneLayout.createSequentialGroup().addComponent(
														playpancontainer, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
														.addGroup(toppaneLayout
																.createParallelGroup(
																...
																.addGroup(toppaneLayout
																		...
																		.addComponent(jButton1,
																				...
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				Short.MAX_VALUE))))
										.addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 1005,
												Short.MAX_VALUE)
										.addGroup(toppaneLayout.createSequentialGroup()
												.addComponent(showtime, javax.swing.GroupLayout.PREFERRED_SIZE, 134,
		...
		toppaneLayout
				.setVerticalGroup(
						toppaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(toppaneLayout.createSequentialGroup().addContainerGap().addComponent(jLabel1)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(toppaneLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addGroup(toppaneLayout.createSequentialGroup().addComponent(exit)
														.addGap(309, 309, 309).addComponent(jButton2)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(jButton1).addGap(59, 59, 59))
												.addGroup(toppaneLayout.createSequentialGroup()
														.addComponent(playpancontainer,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED))
												.addGroup(toppaneLayout.createSequentialGroup()
														.addComponent(minimize).addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED, 426,
																Short.MAX_VALUE)))
										.addGap(8, 8, 8)
										.addGroup(
												toppaneLayout
														...
														.addComponent(showtime, javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				toppane, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
	...
	private void minimizeMouseEntered(java.awt.event.MouseEvent evt) {
		minimize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/min_on.png"))); // NOI18N
	}
	...
	private void exitMouseEntered(java.awt.event.MouseEvent evt) {
		exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/views/x_on.png"))); // NOI18N
	}
